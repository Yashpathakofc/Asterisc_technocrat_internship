...
lblTitle=Label(Tops,font=('arial',60,'bold'),text='The Cafe:HR-26',bd=12,bg='white',
                fg='blue',justify=CENTER)
lblTitle.grid(row=0)

img_logo=Image.open("C:\\Users\patha\OneDrive\Desktop\SUMMER INTERNSHIP\Asterisc internship\Billing-System-master\Billing-System-master\img1.png")
img_logo=img_logo.resize((60,60),Image.ANTIALIAS)
photo_logo=ImageTk.PhotoImage(img_logo)
logo=Label(root,image=photo_logo)
logo.place(x=100,y=50,width=120,height=120)
...
def CostofItem():
    ...
    SubTotalofITEMS = "Rs",str('%.2f'%(PriceofDrinks + PriceofFood - 100))
...
def Receipt():
    ...
    txtReceipt.insert(END,'Discount:\t\t\t\t'+ ServiceCharge.get()+'\nTotal Cost:\t\t\t\t'+str(TotalCost.get())+"\n")


#########################################Drinks####################################################################
Sprite=Checkbutton(Drinks_F,text='Milkshake',variable=var1,onvalue=1,offvalue=0,font=('arial',18,'bold'),
...
DietCoke=Checkbutton(Drinks_F,text='Tea',variable=var3,onvalue=1,offvalue=0,font=('arial',18,'bold'),
...
PaneerTikka = Checkbutton(Food_F,text="Momos\t\t\t ",variable=var9,onvalue = 1, offvalue=0,
...
HamBurger = Checkbutton(Food_F,text="Pizza",variable=var12,onvalue = 1, offvalue=0,
...
###########################################ToTal Cost################################################################################
lblCostofDrinks=Label(Cost_F,font=('arial',14,'bold'),text='Drinks charges\t',bg='cornsilk2',
...
lblCostofFood=Label(Cost_F,font=('arial',14,'bold'),text='Food charges',bg='cornsilk2',
                fg='black',justify=CENTER)
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='Discount',bg='cornsilk2',
                fg='black',justify=CENTER)
